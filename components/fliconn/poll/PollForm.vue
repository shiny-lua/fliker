    ...
    <form class="poll-form position-relative" @submit.prevent="submit">
        ...
        <div class="inputs-wrapper nice-scrollbar pt-1 px-1">
            <textarea v-model="form.detail"
                 ...
                 placeholder="Write about poll in few words..."
                 maxlength="500"
                 required
            ></textarea>
            ...
            <div class="d-flex align-items-center mb-2">
                ...
                <label class="ml-auto d-flex align-items-center mb-0 fp-fs-sm-13" for="allow_multiple_choices">
                    ...
                    <div class="custom-control custom-switch ml-2">
                        <input v-model="form.allow_multiple_choices" type="checkbox" class="custom-control-input" id="allow_multiple_choices">
                        <label class="custom-control-label" for="allow_multiple_choices"></label>
                    </div>
                </label>
            </div>
            <div class="choices">
                <div v-for="(item, index) in form.choices"
                     :key="index"
                     class="input-container mb-3 position-relative"
                >
                    <input v-model="form.choices[index]"
                        type="text"
                        class="form-control"
                        ...
                        required
                    />
                    <a v-if="index > 1" href="javascript:;" class="btn-remove-choice" tabindex="-1" @click.prevent="removeChoice(index)">
        ...
        <div class="d-flex align-items-center">
            ...
            <button type="submit"
                class="btn fp-btn-gradient px-3 px-md-4 ml-2"
