<template>
    <div id="message_panel" class="container-xl">
        <div class="chat-windows" v-if="open_chat">
            <div class="chat-boxes">
                <user-chat-box v-if="chat_user" :chat="chat_user" @read="getUserUnreads" />
                <group-chat-box v-if="chat_group" :group="chat_group" @group-deleted="groupDeleted"
